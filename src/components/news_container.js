      ...
      <div>
        <Row className='container'>
          ...
          <Col span={22}>
            ...
            <div>
              <NewsImageBlock type="guonei" count={8} cardTitle="国内新闻" cardWidth="100%" imageWidth="134px"></NewsImageBlock>
              <NewsImageBlock type="yule" count={16} cardTitle="娱乐新闻" cardWidth="100%" imageWidth="134px"></NewsImageBlock>
            </div>
          </Col>
          <Col span={1}></Col>
        </Row>
